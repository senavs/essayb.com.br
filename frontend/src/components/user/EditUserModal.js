export default function EditUserModal({ bio, url_linkedin, url_instagram, url_website }) {
  // function
          ...
          <div className="modal-body">
            ...
            <form>
              ...
              <div className="mb-3">
                ...
                <textarea name="bio" type="text" maxLength={256} rows={4} className="form-control" />
              </div>
