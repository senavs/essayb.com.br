...
from ...modules.v1.like import check, count_by_id_post, count_by_username, create, delete
from .models.like import CheckResponse, CountResponse, CreateRequest, CreateResponse, DeleteRequest, DeleteResponse
...
def _check(username: str, id_post: int):
